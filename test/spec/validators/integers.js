...
describe('Directive: nguValIntMin', function() {
    ...
    it('shall validate with valid value.', function() {
        el = $compile('<form name="form"><input type="text" name="testValue" ng-model="testValue" ngu-val-int-min="1"></form>')($scope);
        $scope.$digest();
        form = $scope.form;
    ...
    it('shall not validate with invalid value.', function() {
        el = $compile('<form name="form"><input type="text" name="testValue" ng-model="testValue" ngu-val-int-min="5"></form>')($scope);
        $scope.$digest();
        form = $scope.form;
    ...
    it('shall not validate with letter as minimum.', function() {
        el = $compile('<form name="form"><input type="text" name="testValue" ng-model="testValue" ngu-val-int-min="A"></form>')($scope);
        $scope.$digest();
        form = $scope.form;
...
describe('Directive: nguValIntMax', function() {
    ...
    it('shall validate with valid value.', function() {
        el = $compile('<form name="form"><input type="text" name="testValue" ng-model="testValue" ngu-val-int-max="5"></form>')($scope);
        $scope.$digest();
        form = $scope.form;
    ...
    it('shall not validate with letter as maximum.', function() {
        el = $compile('<form name="form"><input type="text" name="testValue" ng-model="testValue" ngu-val-int-max="A"></form>')($scope);
        $scope.$digest();
        form = $scope.form;
